...
from aug_mpc_envs.training_envs.fake_pos_track_env_phase_control import FakePosTrackEnvPhaseControl
...
class FakePosTrackEnvPhaseControlWithDemo(FakePosTrackEnvPhaseControl):
    ...
    def __init__(self,
        ...
        FakePosTrackEnvPhaseControl.__init__(self,
            namespace=namespace,
            verbose=verbose,
            vlevel=vlevel,
            use_gpu=use_gpu,
    ...
    def get_file_paths(self):
        paths=FakePosTrackEnvPhaseControl.get_file_paths(self)
    ...
    def _custom_post_step(self,episode_finished):
        FakePosTrackEnvPhaseControl._custom_post_step(self,episode_finished=episode_finished)
